...
[![Open in Visual Studio Code](https://classroom.github.com/assets/open-in-vscode-718a45dd9cf7e7f842a935f5ebbe5719a5e09af4491e668f4dbf3b35d5cca122.svg)](https://classroom.github.com/online_ide?assignment_repo_id=11573539&assignment_repo_type=AssignmentRepo)
# ProjÁgil - 2023
...
1. **Jogos da plataforma Xbox One**:
   ...
   - **Query**:
     ...
     ```
   - **Resultado**
   - ![Alt text](resultado_5_primeiros_jogos_xboxone.png)
...
2. **Jogos de Ação após 2010**:
   ...
   - **Query**:
     ```sql
      SELECT * FROM vgsales_pbi WHERE genre="Action" AND year >= 2010 ORDER BY year;
     ```
   - **Resultado**
   - ![Alt text](resultado_5_primeiros_jogos_acao_mais_que_2010.png)
...
3. **Jogos mais recentes**:
   ...
   - **Query**:
     ...
     ```
   - **Resultado**
   - ![Alt text](resultado_5_jogos_mais_recentemente_lancados.png)
...
4. **Jogos mais antigos**:
   ...
   - **Query**:
     ...
     ```
   - **Resultado**
   - ![Alt text](resultado_5_jogos_mais_antigos.png)
...
5. **Jogos de Aventura com mais vendas na América do Norte**:
   ...
   - **Query**:
     ...
     ```
   - **Resultado**
   - ![Alt text](resultado_3_jogos_mais_vendidos_NA.png)
...
6. **Jogos de RPG ou Estratégia lançados após 2005**:
   ...
   - **Query**:
     ```sql
      SELECT * FROM vgsales_pbi WHERE (genre = "Role-Playing" OR genre = "Strategy") AND year >= 2005 ORDER BY year;
     ```
   - **Resultado**
   - ![Alt text](resultado_5_primeiros_desde_2005_rpg_strategy.png)
